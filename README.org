...
A package has been made implementing these methods in a small library, available as [[https://github.com/ghost9639/VaR-and-AVaR-Package][a GitHub project]]. My process building and designing the functions is loosely documented in [[file:src/Main.rmd][an R markdown file]].
...
* References
##+cite_export: csl ~/Zotero/styles/chicago-author-date
#+print_bibliography:
